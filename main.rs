/* 	Projeto do Cruzamento Automático - versão s3
...
// Simula 2 carros até saírem do perímetro ou colidirem
...
fn simula_carros( via_carro1: char, acel_carro1: f64, via_carro2:char, acel_carro2: f64) -> bool {
	...
	let mut placa1: String = String::from("ABC1234");	// placa deste carro
	...
	let mut placa2: String = String::from("xyz9876");	// placa deste carro
	//let mut placa2: String = String::from("9yz9876");	// placa deste carro
	//let mut placa2: String = String::from("xyá9876");	// placa deste carro
...
fn valida_placa( placa: &str) -> bool {
	...
	for x in fim.chars() {
		if !x.is_ascii_digit() {
			println!("Placa não tem dígitos no final");
			return false;
		}
	}
